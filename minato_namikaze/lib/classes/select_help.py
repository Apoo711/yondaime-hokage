...
class FrontPageSource(menus.PageSource):
    ...
    def format_page(self, menu: HelpMenu, page):
        ...
        embed.add_field(
            name="Support Server",
            value=f"For more help, consider joining the official server over at https://discord.gg/{LinksAndVars.invite_code.value}",
            inline=False,
        )
        ...
        if self.index == 0:
            embed.add_field(
                name="Who are you?",
                value=(
                    ":pray: Konichiwa :pray:, myself **Minato Namikaze**, **Konohagakure Yondaime Hokage**"
